    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharetbn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent share = new Intent(Autosave.this,SharedActivity.class);
        ...
        accssbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent share = new Intent(Autosave.this,ShareAccess.class);
                share.putExtra("fileid",FileId);
                startActivity(share);
            }
        });
        ...
        FileRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.hasChild("Text")) {
                    String decodetemp = snapshot.child("Text").getValue().toString();
                    DocContent = crypt.decrypt(decodetemp);
                }else {
                    DocContent = "";
                }
